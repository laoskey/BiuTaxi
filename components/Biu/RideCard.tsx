...
function RideCard({ ride }: { ride: Ride }) {
  //   const geoapi = `https://maps.geoapify.com/v1/staticmap?style=osm-bright-smooth&width=600&height=400&center=lonlat:83.985567,28.209583&zoom=14.3497&apiKey=c5aa6d7c9da649f997506c0072e3a40d`;
  return (
